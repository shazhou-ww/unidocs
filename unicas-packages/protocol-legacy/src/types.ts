 ...
 * isPublicCasRoute). Consumed only by the remaining legacy-compatible
 * callers (cas-client, gateways) until they migrate to the canonical
 * stack-scoped `@unicas/protocol` and the retired handlers are removed
 * (Task 9/10). The legacy runtime itself is retired; this package is removed
