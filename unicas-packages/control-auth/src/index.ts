/**
 * Server-only OpenID Connect authorization-code client shared by control-plane
 * ingress adapters. Discovery and JWKS are pinned to the configured issuer;
 * callers receive only a verified immutable subject and display metadata.
 */
