...
export function createControlPlaneOperations(
  ...
  return {
    ...
    listMembers: legacy.listMembers.bind(legacy),
    deleteMember: legacy.deleteMember.bind(legacy),
    createMemberInvitation: legacy.createMemberInvitation.bind(legacy),
    acceptMemberInvitation: legacy.acceptMemberInvitation.bind(legacy),
