...
import { buildWorkers, CAS_PORT, DOC_TYPES } from "../../../scripts/doc-types.mjs";
...
test("buildWorkers leaves bindings untouched when no extraBindings are given", () => {
  ...
  expect(psd.bindings).toEqual({ INTERNAL_TOKEN: "unidocs-dev-token" });
});
