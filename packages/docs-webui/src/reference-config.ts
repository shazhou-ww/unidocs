...
export const references: readonly ReferenceDefinition[] = [
  ...
  },
  {
    ...
    title: "Admin API",
    loadDocument: async () => (await import("@unidocs/protocol-admin-portal/openapi.json")).default as Record<string, unknown>,
    tagGroups: [
    ...
    operationOrder: [
      ...
      "GET /admin/api/v1/document-types/{documentType}/document-contracts",
      "POST /admin/api/v1/document-types/{documentType}/document-contracts",
      "GET /admin/api/v1/document-types/{documentType}/document-contracts/{documentContractIdx}",
      ...
      "GET /admin/api/v1/operators",
      "POST /admin/api/v1/operators",
      "GET /admin/api/v1/operators/{operatorId}",
      "PATCH /admin/api/v1/operators/{operatorId}",
      "GET /admin/api/v1/administrators",
      "POST /admin/api/v1/administrators",
      "GET /admin/api/v1/administrators/{adminId}",
