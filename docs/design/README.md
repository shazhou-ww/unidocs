...
提交可靠性：[Iteration 09](iteration-09.md) 已接通默认关闭的 Cloudflare Markdown 实验提交、核实／恢复和目录同步，并验证八个提交异常窗口，修复提交后异常导致预览读取旧内存的问题。本轮未部署，Azure 持久提交、实际硬崩溃验收和 WebUI 保存仍待完成。
